...
- **735 юнит-тестов**, покрытие 86.83% инструкций и 81.6% ветвей при порогах
  85/80; для доменных политик порог выше — 95%. Из них 236 — серверные, против
  настоящей PostgreSQL.
- **41 Playwright-тест** в четырёх проектах: клавиатурный Chromium 1440 — 21,
  тач-WebKit 820 и 390 — по 2, визуальные сравнения — 16.
